...
This project features **Rock Paper Scissors**, developed as a **Human Machine Interaction** project during the engineering curriculum. It demonstrates the creation of interactive web-based games.
